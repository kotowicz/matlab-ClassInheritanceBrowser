classdef localMethod < classInheritance.helpUtils.classInformation.method
    methods
        function ci = localMethod(classWrapper, className, basePath, derivedPath, derivedClass, methodName, packageName)
            ...
            ci@classInheritance.helpUtils.classInformation.method(classWrapper, packageName, className, methodName, definition, minimalPath, whichTopic);
        end
    end
end
